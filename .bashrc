...
if [ "$color_prompt" = yes ]; then
    PS1='${debian_chroot:+($debian_chroot)}\[\033[01;32m\]\u@\h\[\033[00m\]+\[\033[1;31m\]$(date +%F)\[\033[00m\]:\[\033[01;34m\]\w\[\033[1;33m\]$(parse_git_branch)\[\033[00m\]\$ '
else
    PS1=':${debian_chroot:+($debian_chroot)}\u@\h+$(date +%F):\w$(parse_git_branch)\$ '
fi
